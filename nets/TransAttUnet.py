from backbone.utils4transattunet.unet_parts import *
from backbone.utils4transattunet.unet_parts_att_transformer import *
from backbone.utils4transattunet.unet_parts_att_multiscale import *
...
if __name__ == '__main__':
    ...
    net = UNet_Attention_Transformer_Multiscale(1, 8)
    stat(net, input_size=(1, 512, 512))
